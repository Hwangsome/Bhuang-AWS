locals {
  codestar_enabled = module.this.enabled
}
...
#  https://docs.aws.amazon.com/zh_cn/codepipeline/latest/userguide/action-reference-ECSbluegreen.html
  stage {
    name = "Deploy"
...
#      CodeDeployToECS
      ...
      configuration = {
        ApplicationName: "${var.service_name}-app"
        DeploymentGroupName: "${var.service_name}-group"
