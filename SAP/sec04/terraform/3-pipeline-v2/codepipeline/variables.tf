...
variable "deploy_provider" {
    type        = string
    default     = "ECS"
    description = "The deployment provider to use. Valid values are 'ecs' or 'lambda'"
}

variable "image1_artifact_name" {
    type        = string
    default     = "ImageArtifact"
    description = "The name of the artifact that contains the Docker image to deploy to ECS"
}
...
variable "task_definition_template_artifact" {
    type        = string
    description = "The name of the artifact that contains the task definition template"
}

variable "appspec_template_artifact" {
    type        = string
    description = "The name of the artifact that contains the appspec template"
}